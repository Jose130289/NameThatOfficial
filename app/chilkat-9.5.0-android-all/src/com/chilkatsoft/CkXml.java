...
public class CkXml {
  ...
  public boolean InsertChildTreeAfter(int index, CkXml tree) {
    return chilkatJNI.CkXml_InsertChildTreeAfter(swigCPtr, this, index, CkXml.getCPtr(tree), tree);
  }

  public boolean InsertChildTreeBefore(int index, CkXml tree) {
    return chilkatJNI.CkXml_InsertChildTreeBefore(swigCPtr, this, index, CkXml.getCPtr(tree), tree);
  }
